...
def get_model_for_problem_formulation(problem_formulation_id):
 ...
 # Custom problem formulation
        ...
        dikes_of_interest = ['A.2']
        RfR_of_interest = [0, 1, 2, 3, 4]

        for dike in dikes_of_interest:
            outcomes.append(
                ScalarOutcome(
        ...
        for i in RfR_of_interest:
            outcomes.append(
                ScalarOutcome(
                    f'RfR {i} Individual Costs',
                    variable_name = f"RfR {i} Individual Costs",
                    function=sum_over,
                    kind=direction
                )
            )
...
if __name__ == "__main__":
    get_model_for_problem_formulation(6)
